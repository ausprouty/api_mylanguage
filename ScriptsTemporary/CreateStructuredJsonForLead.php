...
function csvToStructuredJson($filePath, $outputDir)
{
    ...
    while (($row = fgetcsv($file, 0, '|')) !== false) {
        ...
        if (!empty($hlCode)) {
            $outputFile = rtrim($outputDir, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . $hlCode . DIRECTORY_SEPARATOR . 'lead.json';
...
$filePath = 'c:/ampp82/htdocs/api_mylanguage/data/translationImports/LeadershipBeta.txt';
