...
function importTranslations()
{
    ...
    $file = 'LifePrinciplesTranslations.txt';
...
{
    echo "This is an error message:<br> " . $error_message;
    ...
    echo '<ol>
            ...
            <li>Prepared on a <a href="https://docs.google.com/spreadsheets/d/1wOLpkJNbnzzfDd05DRCjkNNEYdR9a0EI3q20VtJ_Fd4/edit#gid=0">Google Spread Sheet</a> which is controlled by bob.prouty@powertochange.org.au</li>
...
<li>Select Paste Special > Transpose:</li>
    ...
    <li>Copy from Excel into Notepad++ and make sure letters are formed correctly</li>
            <li>Place the file in `data/translationImports/LifePrinciplesTranslations.txt`.</li>
          </ol>';
